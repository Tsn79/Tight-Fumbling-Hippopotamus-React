...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Tight Fumbling Hippopotamus</title>
        <meta property="og:title" content="Tight Fumbling Hippopotamus" />
      </Helmet>
        ...
        <div className="home-hero1 heroContainer">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Leading the Future of Crypto Services</span>
                  <span>
                    <span
            ...
            <div className="home-btn-group">
              <button className="buttonFilled">Explore Our Solutions</button>
          ...
          <header className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Explore the innovative features we offer to enhance your
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Customized blockchain solutions for businesses"
              ></FeatureCard>
              <FeatureCard
                heading="Smart Contracts"
                subHeading="Automate and secure transactions with smart contracts"
              ></FeatureCard>
              <FeatureCard
                heading="Tokenization Services"
                subHeading="Create and manage digital assets efficiently"
              ></FeatureCard>
              <FeatureCard
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              <div className="home-container06">
                ...
                <span className="bodySmall">
                  Access basic blockchain services for free
                </span>
              </div>
              ...
              <div className="home-container08">
                ...
                <div className="home-container12">
                  ...
                  <span className="bodySmall">Basic security features</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Get the full suite of blockchain services
                </span>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our company offers a comprehensive range of blockchain
                  services tailored to meet the diverse needs of businesses and
                  individuals. From secure transactions to smart contracts, we
                  are dedicated to revolutionizing the way you interact with
                  blockchain technology. With a team of experts and cutting-edge
                  solutions, we are here to guide you through every step of your
                  blockchain journey. Discover the power of decentralized
                  innovation with us.
                </span>
                <span>
                  <span
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Blockchain technology is a decentralized, distributed ledger system that securely records transactions across a network of computers."
                question="What is blockchain technology?"
              ></Question1>
              <Question1
                answer="Cryptocurrency operates on blockchain technology and uses encryption techniques to regulate the generation of units and verify the transfer of funds."
                question="How does cryptocurrency work?"
              ></Question1>
              <Question1
                answer="Our crypto company offers services such as blockchain development, smart contract creation, tokenization, and consulting for blockchain projects."
                question="What services does your crypto company offer?"
              ></Question1>
              <Question1
                answer="Cryptocurrency transactions are secure due to the cryptographic nature of blockchain technology, but users should still take precautions to protect their digital assets."
                question="Is cryptocurrency safe to use?"
              ></Question1>
              <Question1
                answer="To start using cryptocurrency, you can create a digital wallet, purchase coins from exchanges, and familiarize yourself with the basics of blockchain technology."
                question="How can I get started with using cryptocurrency?"
              ></Question1>
            </div>
          </div>
        </div>
